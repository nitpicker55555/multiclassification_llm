...
def draw_barchart_func():
    mapping = {
        ...
        'Attributes Caused by Untimely Maintenance of Training Data': 'user did not update data in time',
        # 'Attributes Generated by Large Model': 'incorrect design intent',
        'Plan and Design': 'incorrect design intent',
        'Data Acquisition and Processing': 'data set is inaccurate',
    ...
    "Influential Attributes of Self-identity and Values"
        ...
        [
            ...
            "User Usage and Its Influencing Factors"
        ],
        [
            "Psychological Harm",
            "Physical Harm",
    ...
    print(all_word)
draw_barchart_func()
def draw_barchart(categories,existence,num):
    import matplotlib.pyplot as plt
